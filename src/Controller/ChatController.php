...
final class ChatController extends AbstractController
{
    ...
    #[Route('/new/{id}', name: 'app_chat_new', methods: ['GET', 'POST'])]
    public function new(
        Potentiel $potentiel,Request $request, EntityManagerInterface $entityManager): Response
    {
        $chat = new Chat();
        $chat->setPotentiel($potentiel)
             ->setOwner($potentiel->getUser())
